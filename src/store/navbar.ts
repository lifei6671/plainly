...
// 如果为空先把数据放进去
if (getConfigSync(TEMPLATE_NUM, null) === null) {
  setConfigSync(TEMPLATE_NUM, 0);
}

// 如果为空先把数据放进去
if (getConfigSync(CODE_NUM, null) === null) {
...
if (getConfigSync(IS_SYNC_SCROLL, null) === null) {
  setConfigSync(IS_SYNC_SCROLL, true);
}

if (getConfigSync(IS_CONTAIN_IMG_NAME, null) === null) {
  setConfigSync(IS_CONTAIN_IMG_NAME, false);
}

if (getConfigSync(IS_MAC_CODE, null) === null) {
