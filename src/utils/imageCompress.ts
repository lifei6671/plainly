...
async function fileToImageBitmap(file: Blob) {
  // createImageBitmap 在主流浏览器/多数 WebView 可用
  return createImageBitmap(file);
}

function calcTargetSize(w: number, h: number, {maxWidth = 2560, maxHeight = 2560}: CompressOptions = {}) {
 ...
 */
export default async function compressThenWebp(file: Blob, opts: CompressOptions = {}) {
