...
export type ImageHostingName = "smms" | "aliyun" | "qiniuyun" | "r2";
...
export type CodeOption = Readonly<{
  id: string;
  name: string;
  macId?: string;
}>;

export type SitdownOption = Readonly<{
  key: string;
  value: string;
}>;

export const IMAGE_HOSTING_NAMES: Readonly<Record<ImageHostingName, string>> = {
  smms: "SM.MS",
  aliyun: "阿里云",
  qiniuyun: "七牛云",
  r2: "CF R2",
...
export const STYLE_LABELS = ["basic-theme", "markdown-theme", "code-theme", "font-theme"] as const;
...
export const CODE_OPTIONS: readonly CodeOption[] = [
  {
    id: "wechat",
    name: "微信代码主题",
  },
...
export const SITDOWN_OPTIONS: readonly SitdownOption[] = [
  {
    key: "wechat",
